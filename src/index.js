...
cronofy.prototype._httpPost = function (
  path,
  options,
  callback,
  optionsToOmit,
...
cronofy.prototype._httpDelete = function (
  path,
  options,
  callback,
  optionsToOmit,
...
cronofy.prototype.authorizeWithServiceAccount = function () {
  ...
  return this._httpPost(
    "/v1/service_account_authorizations",
    details.options,
    details.callback,
  );
};
...
cronofy.prototype.listAvailablePeriods = function () {
  ...
  if (details.options.next_page) {
    return this._httpCall(
      "GET",
      details.options.next_page,
      details.options,
      details.callback,
      ["access_token", "next_page"],
    );
  }
...
cronofy.prototype.readAvailabilityRule = function () {
  ...
  return this._httpGet(
    "/v1/availability_rules/" + availabilityRuleId,
    details.options,
    details.callback,
  );
};
...
cronofy.prototype.deleteAvailabilityRule = function () {
  ...
  return this._httpDelete(
    "/v1/availability_rules/" + details.options.availability_rule_id,
    details.options,
    details.callback,
  );
};
...
cronofy.prototype.createEvent = function () {
  ...
  return this._httpPost(
    "/v1/calendars/" + details.options.calendar_id + "/events",
    details.options,
    details.callback,
...
cronofy.prototype.bulkDeleteEvents = function () {
  ...
  return this._httpDelete("/v1/events", details.options, details.callback, [
    "access_token",
  ]);
};
...
cronofy.prototype.deleteNotificationChannel = function () {
  ...
  return this._httpDelete(
    "/v1/channels/" + details.options.channel_id,
    details.options,
    details.callback,
...
cronofy.prototype.applicationCalendar = function () {
  var that = this;
  var details = this._parseArguments(arguments, [
    "client_id",
    "client_secret",
    "application_calendar_id",
  ]);

  return this._httpPost("/v1/application_calendars", details.options).then(
...
cronofy.prototype.revokeProfileAuthorization = function () {
  ...
  return this._httpPost(
    "/v1/profiles/" + details.options.profile_id + "/revoke",
    details.options,
    details.callback,
  );
};
...
cronofy.prototype.refreshAccessToken = function () {
  ...
  return this._httpPost("/oauth/token", details.options).then(
    tap(function (token) {
...
cronofy.prototype.hmacValid = function () {
  ...
  var calculated = crypto
    .createHmac("sha256", details.options.client_secret)
    .update(details.options.body)
    .digest("base64");
...
cronofy.prototype.revokeAuthorization = function () {
  ...
  return this._httpPost("/oauth/token/revoke", details.options).then(
    tap(function () {
...
cronofy.prototype.getSmartInvite = function () {
  ...
  return this._httpGet("/v1/smart_invites", details.options, details.callback, [
    "client_secret",
    "access_token",
    "bearer_token",
  ]);
...
cronofy.prototype.createSmartInvite = function () {
  ...
  return this._httpPost(
    ...
    details.options,
    details.callback,
    ["access_token", "client_secret", "bearer_token"],
  );
};
...
cronofy.prototype.conferencingServiceAuthorizations = function () {
  ...
  return this._httpPost(
    "/v1/conferencing_service_authorizations",
    details.options,
    details.callback,
  );
};
...
cronofy.prototype.upsertRegistrationBookableEvent = function () {
  ...
  return this._httpPost(
    "/v1/bookable_events/" +
      details.options.bookable_event_id +
      "/registrations",
    details.options,
    details.callback,
    ["client_secret"],
...
cronofy.prototype.deleteRegistrationBookableEvent = function () {
  ...
  return this._httpDelete(
    "/v1/bookable_events/" +
      details.options.bookable_event_id +
      "/registrations/" +
      details.options.registration_id,
    details.options,
    details.callback,
    ["client_secret"],
  );
